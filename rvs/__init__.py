...
from .intent_overlay import IntentOverlay, plan_path
...
from .proprio import CommandState, EgoState, EgoStateProvider, EgoVerdict, ProprioGate
...
__all__ = [
    "__version__",
    # 本体系（核心增量）
    "CommandState", "EgoState", "EgoStateProvider", "EgoVerdict", "ProprioGate",
    # 机器人桥与双相机编排
